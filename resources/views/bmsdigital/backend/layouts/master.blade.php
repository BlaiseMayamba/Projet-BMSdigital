...
<head>
    @include('bmsdigital.backend.common.meta.meta')
    @include('bmsdigital.backend.common.meta.styles')
</head>
...
<body>
    ...
    <div id="main-wrapper">
        @include('bmsdigital.backend.common.header.header')
    ...
    @include('bmsdigital.backend.common.meta.scripts')
    <script>
